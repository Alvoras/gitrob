...
func ParseOptions() (Options, error) {
	options := Options{
		...
		RepositoriesOpt:   flag.String("repo", "", "Repositories to scan for"),
	...
	if len(*options.RepositoriesOpt) > 0 {
		options.Repositories = strings.Split(*options.RepositoriesOpt, ",")
	}
